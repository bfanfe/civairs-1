...
/**
 * <p>Classe Java pour VL1117_5_0_1_1.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * <p>
 * <pre>
 * &lt;simpleType name="VL1117_5_0_1_1">
 ...
 *     &lt;enumeration value="Closed on issue"/>
 *   &lt;/restriction>
 * &lt;/simpleType>
 * </pre>
 * 
 */
@XmlType(name = "VL1117_5_0_1_1")
@XmlEnum
public enum VL11175011 {
    ...
    /**
     * Once a Report is drafted there is a period of 60 days where foreign States are allowed to comment before the final report is published. 
     * 
     */
    @XmlEnumValue("Draft")
    DRAFT("Draft"),
    ...
    /**
     * Report closed by the reporting organisation on  first its issuance
     * 
     */
    @XmlEnumValue("Closed on issue")
    CLOSED_ON_ISSUE("Closed on issue");
    ...
    public static VL11175011 fromValue(String v) {
        for (VL11175011 c: VL11175011 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
