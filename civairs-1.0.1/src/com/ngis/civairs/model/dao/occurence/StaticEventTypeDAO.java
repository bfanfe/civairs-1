...
@Stateless
public class StaticEventTypeDAO {
	
	@PersistenceContext(unitName = "civairs_db_pu")
	private EntityManager em;

	public String insert(StaticEventType toInsert) {
	...
	public String update(StaticEventType toUpdate) {
		// TODO Auto-generated method stub
	...
	public String delete(StaticEventType toDelete) {
		// TODO Auto-generated method stub
		if (toDelete != null && toDelete.getValueID() != null && !toDelete.getValueID().isEmpty()) {
			try {
				StaticEventType dbEntity = selectByValueID(toDelete.getValueID());
				if(dbEntity != null) {
					em.remove(dbEntity);
				}
				toDelete = null;
	...
	public List<StaticEventType> selectAll() {
		// TODO Auto-generated method stub Notification.findAll
		return em.createNamedQuery("StaticEventType.findAll").getResultList();
	}
	...
	public StaticEventType selectByValueID(String iD) {
		// TODO Auto-generated method stub
		try {
			return em.find(StaticEventType.class, iD);
		} catch (Exception e) {
			return null;
		}
	}

	public List<StaticEventType> customSelect() {
		// TODO Auto-generated method stub
		return null;
	}
