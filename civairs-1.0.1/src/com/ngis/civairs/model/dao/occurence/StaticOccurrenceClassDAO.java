...
@Stateless
public class StaticOccurrenceClassDAO {
	
	@PersistenceContext(unitName = "civairs_db_pu")
	private EntityManager em;

	public String insert(StaticOccurrenceClass toInsert) {
	...
	public String update(StaticOccurrenceClass toUpdate) {
		// TODO Auto-generated method stub
	...
	public String delete(StaticOccurrenceClass toDelete) {
		// TODO Auto-generated method stub
		if (toDelete != null && toDelete.getValueID() != null && !toDelete.getValueID().isEmpty()) {
			try {
				StaticOccurrenceClass dbEntity = selectByValueID(toDelete.getValueID());
				if(dbEntity != null) {
					em.remove(dbEntity);
				}
				toDelete = null;
	...
	public List<StaticOccurrenceClass> selectAll() {
		// TODO Auto-generated method stub Notification.findAll
		return em.createNamedQuery("StaticOccurrenceClass.findAll").getResultList();
	}
	...
	public StaticOccurrenceClass selectByValueID(String iD) {
		// TODO Auto-generated method stub
		try {
			return em.find(StaticOccurrenceClass.class, iD);
		} catch (Exception e) {
			return null;
		}
	}

	public List<StaticOccurrenceClass> customSelect() {
		// TODO Auto-generated method stub
		return null;
	}
