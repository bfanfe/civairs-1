...
@Stateless
public class StaticEventFrequencyDAO {
	
	@PersistenceContext(unitName = "civairs_db_pu")
	private EntityManager em;

	public String insert(StaticEventFrequency toInsert) {
	...
	public String update(StaticEventFrequency toUpdate) {
		// TODO Auto-generated method stub
	...
	public String delete(StaticEventFrequency toDelete) {
		// TODO Auto-generated method stub
		if (toDelete != null && toDelete.getValueID() != null && !toDelete.getValueID().isEmpty()) {
			try {
				StaticEventFrequency dbEntity = selectByValueID(toDelete.getValueID());
				if(dbEntity != null) {
					em.remove(dbEntity);
				}
				toDelete = null;
	...
	public List<StaticEventFrequency> selectAll() {
		// TODO Auto-generated method stub Notification.findAll
		return em.createNamedQuery("StaticEventFrequency.findAll").getResultList();
	}
	...
	public StaticEventFrequency selectByValueID(String iD) {
		// TODO Auto-generated method stub
		try {
			return em.find(StaticEventFrequency.class, iD);
		} catch (Exception e) {
			return null;
		}
	}

	public List<StaticEventFrequency> customSelect() {
		// TODO Auto-generated method stub
		return null;
	}
