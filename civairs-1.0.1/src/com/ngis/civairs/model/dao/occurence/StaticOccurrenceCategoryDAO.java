...
public class StaticOccurrenceCategoryDAO {
	...
	public String insert(StaticOccurrenceCategory toInsert) {
	...
	public String update(StaticOccurrenceCategory toUpdate) {
		// TODO Auto-generated method stub
	...
	public String delete(StaticOccurrenceCategory toDelete) {
		// TODO Auto-generated method stub
		if (toDelete != null && toDelete.getValueID() != null && !toDelete.getValueID().isEmpty()) {
			try {
				StaticOccurrenceCategory dbEntity = selectByValueID(toDelete.getValueID());
				if(dbEntity != null) {
					em.remove(dbEntity);
				}
				toDelete = null;
	...
	public List<StaticOccurrenceCategory> selectAll() {
		// TODO Auto-generated method stub Notification.findAll
		return em.createNamedQuery("StaticOccurrenceCategory.findAll").getResultList();
	}
	...
	public StaticOccurrenceCategory selectByValueID(String iD) {
		// TODO Auto-generated method stub
		try {
			return em.find(StaticOccurrenceCategory.class, iD);
		} catch (Exception e) {
			return null;
		}
	}

	public List<StaticOccurrenceCategory> customSelect() {
		// TODO Auto-generated method stub
		return null;
	}
